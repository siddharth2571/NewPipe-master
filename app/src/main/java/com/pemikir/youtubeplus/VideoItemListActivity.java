...
import com.pemikir.youtubeplus.textPackage.SecretTextView;
...
public class VideoItemListActivity extends AppCompatActivity
    ...
    private LocalVideoItemFragment locallistFragment;

    SecretTextView secretText;
    PathView logoPathView;
...
//            waterMark.setVisibility(View.GONE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative = (RelativeLayout) findViewById(R.id.container);
        secretText = (SecretTextView) findViewById(R.id.secretText);
        logoPathView = (PathView) findViewById(R.id.pathView);

        secretText.toggle();
        secretText.setDuration(2000);

        logoPathView.getPathAnimator()
                .delay(100)
                .duration(4000)
...
//        fragmentTransaction.replace(R.id.local_videoitem_list, fragment);
